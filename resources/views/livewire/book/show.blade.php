  ...
  <div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
      ...
      <div class="d-flex align-items-center py-1">
        ...
        <!--end::Wrapper-->
        <!--begin::Button-->
        <div class="d-inline" x-data="{progress: 0 }" x-on:livewire-upload-start="progress = 0"
          x-on:livewire-upload-error="progress = 0" x-on:livewire-upload-progress="progress = $event.detail.progress">
          <button onclick="document.getElementById('input-file').click()" class="btn btn-sm btn-primary"
            data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button"
            title="Unggah file buku baru" wire:loading.attr="disabled" wire:target="book">
            <span wire:loading.remove wire:target="book" class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
              <i class="fa fa-plus"></i>
            </span>
            <span wire:loading.remove wire:target="book">Buku baru</span>
            <span wire:loading wire:target="book">(<span x-text="progress"></span>%) Mengunggah</span>

          </button>
          <input type="file" id="input-file" wire:model="book" class="d-none" accept="application/pdf,application/odf">
        </div>
        <!--end::Button-->
      </div>
      <!--end::Actions-->
              ...
              <div class="table-responsive">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                  ...
                  <tbody>
                    ...
                    @livewire('book.row-book', ['book' => $book], key($book->id))
                    @endforeach
                  </tbody>
                  <!--end::Table body-->
                </table>
