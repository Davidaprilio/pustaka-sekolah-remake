          ...
          <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body pt-2">
              ...
              <div class="table-responsive">
                <!--begin::Table-->
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" wire:poll.4s>
                  <!--begin::Table head-->
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr wire:key="{{ $loop->iteration }}">
                      ...
                      <td>
                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">
                          {{$act->updated_at->diffForHumans()}}</a>
                        <span class="text-muted fw-bold text-muted d-block fs-7">{{
                          $act->publisher ?? '- ' }}</span>
                      </td>
                      <td class="text-end">
                      ...
                      <td>
                        <div class="d-flex justify-content-end flex-shrink-0">
                          ...
                          <button wire:click="delete({{ $act->id }})"
                    ...
                    <tr>
                      <td colspan="4">
                        <h4 class="text-muted pt-2 w-100 text-center">Tidak Ada Data</h4>
                      </td>
                    </tr>
                    @endif
                  </tbody>
